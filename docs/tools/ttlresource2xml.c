                      ...
                      GList         *properties)
{
	...
	g_fprintf (f, "<thead><row><entry>Name</entry><entry>Type</entry><entry>Flags</entry><entry>Description</entry></row></thead>");
	...
	for (l = properties; l; l = l->next) {
		...
		if (prop->fulltextIndexed) {
			...
			g_fprintf (f, "    <imageobject><imagedata fileref=\"icon-fulltextindexed.svg\" /></imageobject>");
			g_fprintf (f, "    <alt>This property is full-text-indexed, and can be looked up through <literal>fts:match</literal></alt>");
			g_fprintf (f, "  </inlinemediaobject>");
			g_fprintf (f, "</link>");
		}
