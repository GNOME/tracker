/* tracker-status.c generated by valac 0.40.8, the Vala compiler
...
static void tracker_status_wait_async_ready_wrapper (GObject *source_object,
                                              GAsyncResult *res,
                                              void *user_data);
...
{
#line 36 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	(var == NULL) ? NULL : (var = (g_object_unref (var), NULL));
#line 245 "tracker-status.c"
}
...
tracker_status_busy_notification_timeout (TrackerStatus* self)
{
	...
	const gchar* _tmp0_;
	gdouble _tmp1_;
#line 57 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 59 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
#line 61 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	self->priv->timer_id = (guint) 0;
#line 63 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	result = FALSE;
#line 63 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	return result;
#line 278 "tracker-status.c"
}
...
{
#line 75 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
#line 88 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	return result;
                         ...
                         gdouble progress)
{
	...
	const gchar* _tmp6_;
	guint _tmp8_;
#line 68 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	g_return_if_fail (self != NULL);
#line 68 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	g_return_if_fail (status != NULL);
#line 69 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	self->priv->_progress = progress;
#line 71 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
#line 332 "tracker-status.c"
		GList* _tmp2_;
#line 74 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
#line 75 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
				context = _tmp3_;
#line 353 "tracker-status.c"
				{
					TrackerStatusWaitContext* _tmp4_;
					GSourceFunc _tmp5_;
					void* _tmp5__target;
#line 76 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
					_tmp4_ = context;
#line 76 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
#line 79 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
#line 82 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	_tmp6_ = self->priv->status;
#line 82 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	if (g_strcmp0 (status, _tmp6_) != 0) {
#line 382 "tracker-status.c"
		gchar* _tmp7_;
#line 83 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
		_tmp7_ = g_strdup (status);
#line 83 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
		_g_free0 (self->priv->status);
#line 83 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
		self->priv->status = _tmp7_;
#line 390 "tracker-status.c"
	}
#line 86 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	_tmp8_ = self->priv->timer_id;
#line 86 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	if (_tmp8_ == ((guint) 0)) {
#line 396 "tracker-status.c"
		gboolean _tmp9_;
#line 87 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
#line 89 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
			tracker_status_first_time = FALSE;
#line 406 "tracker-status.c"
		} else {
#line 91 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
#line 410 "tracker-status.c"
		}
	}
#line 95 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	while (TRUE) {
...
_tracker_status_callback_tracker_busy_callback (const gchar* status,
                                                ...
                                                gpointer self)
{
#line 101 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	tracker_status_callback ((TrackerStatus*) self, status, progress);
#line 436 "tracker-status.c"
}
...
#line 100 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
                             ...
                             GError** error)
{
	gdouble result = 0.0;
	gdouble _tmp0_;
#line 104 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	g_return_val_if_fail (self != NULL, 0.0);
#line 105 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
                           ...
                           GError** error)
{
	...
	const gchar* _tmp0_;
	gchar* _tmp1_;
#line 108 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 109 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = self->priv->status;
#line 109 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
tracker_status_wait_data_free (gpointer _data)
{
	...
	_data_ = _data;
#line 24 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
static void
tracker_status_wait_async_ready_wrapper (GObject *source_object,
                                         GAsyncResult *res,
                                         void *user_data)
{
	TrackerStatusWaitData* _task_data_;
#line 24 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
#line 533 "tracker-status.c"
	}
#line 24 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	_task_data_->_task_complete_ = TRUE;
#line 537 "tracker-status.c"
}
...
#line 24 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	_data_->_async_result = g_task_new (G_OBJECT (self), NULL, tracker_status_wait_async_ready_wrapper, _user_data_);
#line 24 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	if (_callback_ == NULL) {
#line 24 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
#line 117 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	return result;
...
{
#line 112 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
#line 616 "tracker-status.c"
	...
	_state_0:
#line 113 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	_data_->_tmp0_ = _data_->self->priv->status;
#line 113 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	if (g_strcmp0 (_data_->_tmp0_, "Idle") == 0) {
#line 623 "tracker-status.c"
	} else {
#line 116 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
#line 117 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
		_data_->_tmp2_->callback_target_destroy_notify = NULL;
#line 118 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
#line 119 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
		_data_->_state_ = 1;
#line 119 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
		return FALSE;
#line 655 "tracker-status.c"
		_state_1:
		;
#line 113 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
		_g_object_unref0 (_data_->context);
#line 660 "tracker-status.c"
	}
#line 112 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
#line 29 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
#line 30 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
...
#line 34 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = g_strdup ("Idle");
#line 34 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	self->priv->status = _tmp0_;
#line 849 "tracker-status.c"
}
...
#line 52 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = self->priv->timer_id;
#line 52 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	if (_tmp0_ != ((guint) 0)) {
#line 864 "tracker-status.c"
		guint _tmp1_;
#line 53 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
		_tmp1_ = self->priv->timer_id;
#line 53 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
		g_source_remove (_tmp1_);
#line 870 "tracker-status.c"
	}
#line 34 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
	_g_free0 (self->priv->status);
#line 36 "/home/sumaid/gsoc/tracker/src/tracker-store/tracker-status.vala"
                                   ...
                                   GDBusMethodInvocation* invocation)
{
	...
	result = tracker_status_get_progress (self, &error);
	if (error) {
                                 ...
                                 GDBusMethodInvocation* invocation)
{
	...
	gchar* result;
	g_variant_iter_init (&_arguments_iter, _parameters_);
	result = tracker_status_get_status (self, &error);
	if (error) {
		g_dbus_method_invocation_return_gerror (invocation, error);
		return;
	}
