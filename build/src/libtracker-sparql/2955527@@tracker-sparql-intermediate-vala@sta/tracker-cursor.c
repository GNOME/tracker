/* tracker-cursor.c generated by valac 0.40.8, the Vala compiler
...
tracker_sparql_cursor_real_get_value_type (TrackerSparqlCursor* self,
                                           gint column)
{
#line 126 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
tracker_sparql_cursor_real_get_variable_name (TrackerSparqlCursor* self,
                                              gint column)
{
#line 139 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
tracker_sparql_cursor_real_get_string (TrackerSparqlCursor* self,
                                       ...
                                       glong* length)
{
#line 155 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
tracker_sparql_cursor_next_async (TrackerSparqlCursor* self,
                                  ...
                                  gpointer _user_data_)
{
#line 65 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	TRACKER_SPARQL_CURSOR_GET_CLASS (self)->next_async (self, cancellable, _callback_, _user_data_);
#line 383 "tracker-cursor.c"
}
...
{
#line 217 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_if_fail (self != NULL);
#line 217 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	TRACKER_SPARQL_CURSOR_GET_CLASS (self)->close (self);
#line 449 "tracker-cursor.c"
}
                                        ...
                                        gint column)
{
	...
	const gchar* _tmp0_;
#line 232 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (tracker_sparql_cursor_get_value_type (self, column) == TRACKER_SPARQL_VALUE_TYPE_INTEGER, 0);
#line 233 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp0_ = tracker_sparql_cursor_get_string (self, column, NULL);
#line 233 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	as_str = _tmp0_;
#line 234 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	result = int64_parse (as_str);
#line 234 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	return result;
#line 498 "tracker-cursor.c"
}
...
tracker_sparql_cursor_get_integer (TrackerSparqlCursor* self,
                                   gint column)
{
#line 231 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (self != NULL, 0LL);
#line 231 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	return TRACKER_SPARQL_CURSOR_GET_CLASS (self)->get_integer (self, column);
#line 510 "tracker-cursor.c"
}
                                       ...
                                       gint column)
{
	...
	const gchar* as_str = NULL;
	const gchar* _tmp0_;
#line 249 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (tracker_sparql_cursor_get_value_type (self, column) == TRACKER_SPARQL_VALUE_TYPE_DOUBLE, 0);
#line 250 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp0_ = tracker_sparql_cursor_get_string (self, column, NULL);
#line 250 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	as_str = _tmp0_;
#line 251 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	result = double_parse (as_str);
#line 251 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	return result;
#line 559 "tracker-cursor.c"
}
...
tracker_sparql_cursor_get_double (TrackerSparqlCursor* self,
                                  gint column)
{
#line 248 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (self != NULL, 0.0);
#line 248 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	return TRACKER_SPARQL_CURSOR_GET_CLASS (self)->get_double (self, column);
#line 571 "tracker-cursor.c"
}
                                        ...
                                        gint column)
{
	...
	const gchar* _tmp3_;
#line 266 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	type = tracker_sparql_cursor_get_value_type (self, column);
#line 267 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp0_ = type;
#line 267 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (_tmp0_ == TRACKER_SPARQL_VALUE_TYPE_BOOLEAN, 0);
#line 268 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp1_ = tracker_sparql_cursor_get_string (self, column, NULL);
#line 268 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	as_str = _tmp1_;
#line 270 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp3_ = as_str;
#line 270 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	if (_tmp3_ != NULL) {
#line 611 "tracker-cursor.c"
		const gchar* _tmp4_;
#line 270 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
		_tmp4_ = as_str;
#line 270 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
		_tmp2_ = g_ascii_strcasecmp (_tmp4_, "true") == 0;
#line 617 "tracker-cursor.c"
	} else {
#line 270 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
		_tmp2_ = FALSE;
#line 621 "tracker-cursor.c"
	}
#line 270 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	if (_tmp2_) {
#line 271 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
		result = TRUE;
#line 271 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
		return result;
#line 629 "tracker-cursor.c"
	}
#line 274 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	result = FALSE;
#line 274 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	return result;
#line 635 "tracker-cursor.c"
}
...
tracker_sparql_cursor_get_boolean (TrackerSparqlCursor* self,
                                   gint column)
{
#line 265 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 265 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	return TRACKER_SPARQL_CURSOR_GET_CLASS (self)->get_boolean (self, column);
#line 647 "tracker-cursor.c"
}
...
{
	gboolean result = FALSE;
#line 289 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	if (tracker_sparql_cursor_get_value_type (self, column) != TRACKER_SPARQL_VALUE_TYPE_UNBOUND) {
#line 290 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
		result = TRUE;
#line 290 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
		return result;
#line 673 "tracker-cursor.c"
	}
#line 292 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	result = FALSE;
#line 292 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	return result;
...
tracker_sparql_cursor_is_bound (TrackerSparqlCursor* self,
                                gint column)
{
#line 288 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 288 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
#line 85 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 85 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
{
#line 88 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
{
#line 112 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (self != NULL, 0);
#line 112 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	return TRACKER_SPARQL_CURSOR_GET_CLASS (self)->get_n_columns (self);
#line 786 "tracker-cursor.c"
}
...
#line 74 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_g_object_unref0 (self->priv->_connection);
#line 65 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
	G_OBJECT_CLASS (tracker_sparql_cursor_parent_class)->finalize (obj);
#line 866 "tracker-cursor.c"
}
...
#line 65 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
		break;
#line 906 "tracker-cursor.c"
		default:
#line 65 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
		G_OBJECT_WARN_INVALID_PROPERTY_ID (object, property_id, pspec);
#line 65 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
		break;
#line 912 "tracker-cursor.c"
	}
}
...
#line 65 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
		break;
#line 933 "tracker-cursor.c"
		default:
#line 65 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
		G_OBJECT_WARN_INVALID_PROPERTY_ID (object, property_id, pspec);
#line 65 "/home/sumaid/gsoc/tracker/src/libtracker-sparql/tracker-cursor.vala"
		break;
#line 939 "tracker-cursor.c"
	}
}
